    ...
    <h1 class="page-heading">Add Guest</h1>
      <div class="form-content container">
        ...
        <form id="guest-form">
          <ul class="add-guest">
            ...
            <li>
              ...
              <select name="commercial-flight" id="commercial-flight">
                <option value="NULL">Commercial Flight</option>
            ...
            <li>
              ...
              <select name="transport" id="transport">
                <option value="NULL">Select Transport</option>
                <option value="Yes">YES</option>
            ...
            <li>
              ...
              <select name="invited-by" id="invited-by">
                <option value="NULL">Select Inviter</option>
          ...
          <!-- Submit button -->
          <input type="submit" id="save-guest" name="submit" value="Add Guest">
        </form>
      </div>
    </div>
  </main>
